...
<body class="bg-dark imgbody">
    <div class="container-fluid">
        <div class="row vh-95">
            <div class="d-flex col-md-6 w-100 align-items-center bg-grid">
            ...
            <div class="d-flex col-md-6 w-100 align-items-center">
                <div class="m-auto text-size shadow-text text-white">
                    ...
                    <button type="button" href="connexion.php" class="btn btn-primary px">Se connecter</button>
                    </a>
                </div>
            </div>
        </div>
        <div class="row vh-5">
            <div class="d-flex col-md-12 align-items-center w-100 bg-primary">
                <footer class="m-auto font-weight-lighter font-weight-bolder font-italic">
                    Design/codage created by KOKSAL Adem, CUISINER Aubin, KALKOUL Khadidja and RAMOND Nicolas !
